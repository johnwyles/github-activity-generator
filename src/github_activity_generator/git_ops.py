...
class GitOperations:
    ...
    def __init__(self, dry_run: bool = False, verbose: bool = False, dry_run_simulator = None):
        ...
        self.dry_run_simulator = dry_run_simulator or (DryRunSimulator(verbose) if dry_run else None)
